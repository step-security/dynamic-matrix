...
def validate_subscription() -> None:
    """Check if the StepSecurity subscription is valid for this repository."""
    repo_private = None
    ...
    upstream = "coactions/dynamic-matrix"
    action = os.environ.get("GITHUB_ACTION_REPOSITORY", "")
    docs_url = "https://docs.stepsecurity.io/actions/stepsecurity-maintained-actions"

    core.info("")
    core.info("\u001b[1;36mStepSecurity Maintained Action\u001b[0m")
    core.info(f"Secure drop-in replacement for {upstream}")
    if repo_private is False:
        core.info("\u001b[32m✓ Free for public repositories\u001b[0m")
    core.info(f"\u001b[36mLearn more:\u001b[0m {docs_url}")
    core.info("")
    ...
    api_url = (
        f"https://agent.api.stepsecurity.io/v1/github/{os.environ.get('GITHUB_REPOSITORY')}"
    ...
    try:
        ...
        if exc.code == 403:  # noqa: PLR2004
            ...
            core.error(f"\u001b[31mLearn how to enable a subscription: {docs_url}\u001b[0m")
            sys.exit(1)
